...
public class LodgeServiceTest {
    ...
    @Test
    public void testCreateLodge() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
        ...
        Lodge lodge = lodgeService.createLodge(user.getId(), "Lodge1@udc.es", "Lodge1", "Description", "Address",
    ...
    @Test
    public void testFindByCity() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
            InvalidBirthdateException {
        User user = createUser5Args("user1");
        userService.signUp(user);
        List<Long> featureIds = new ArrayList<>(Arrays.asList(1L, 2L, 6L));
        ...
        Lodge lodge = lodgeService.createLodge(user.getId(), "Lodge1@udc.es", "Lodge1", "Description", "Address",
                "981981981", "City", "Country", 5, 50, "12:00", "10:00", featureIds, imageUrls);
        Lodge lodge2 = lodgeService.createLodge(user.getId(), "Lodge2@udc.es", "Lodge1", "Description", "Address",
                "981981981", "City", "Country", 5, 50, "12:00", "10:00", featureIds, imageUrls);
        Lodge lodge3 = lodgeService.createLodge(user.getId(), "Lodge3@udc.es", "Lodge1", "Description", "Address",
    ...
    @Test
    public void testFindByCountry() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
            InvalidBirthdateException {
        User user = createUser5Args("user1");
        userService.signUp(user);
        List<Long> featureIds = new ArrayList<>(Arrays.asList(1L, 2L, 6L));
    ...
    @Test
    public void testFindByPlace() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
            InvalidBirthdateException {
        User user = createUser5Args("user1");
        userService.signUp(user);
        List<Long> featureIds = new ArrayList<>(Arrays.asList(1L, 2L, 6L));
    ...
    @Test
    public void testFindByPlace2() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
            InvalidBirthdateException {
        User user = createUser5Args("user1");
        userService.signUp(user);
        List<Long> featureIds = new ArrayList<>(Arrays.asList(1L, 2L, 6L));
    ...
    public void testUpdateLodge()
        ...
        lodgeService.updateLodge(user.getId(), "Lodge1@udc.es", "Lodge1Updated", "DescriptionUpdated", "AddressUpdated",
                "111222111", "CityUpdated", "CountryUpdated", 100, 1000, "00:00", "00:00", featureIdsUpdated,
                imageUrls);
    ...
    @Test
    public void testUpdateLodge2() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
            InvalidBirthdateException, PermissionException {
        User user = createUser5Args("user1");
        userService.signUp(user);
        ...
        assertThrows(PermissionException.class,
                () -> lodgeService.updateLodge(user2.getId(), "Lodge1@udc.es", "Lodge1Updated", "DescriptionUpdated",
                        "AddressUpdated",
                        "111222111", "CityUpdated", "CountryUpdated", 100, 1000, "00:00", "00:00", featureIds,
                        imageUrls));
    }

    @Test
    public void testCloseLodge() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
            InvalidBirthdateException, PermissionException {
        User user = createUser5Args("user1");
        userService.signUp(user);
        List<Long> featureIds = new ArrayList<>(Arrays.asList(1L, 2L, 6L));
    ...
    @Test
    public void testCloseLodge2() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
            InvalidBirthdateException, PermissionException {
        User user = createUser5Args("user1");
        userService.signUp(user);
        User user2 = createUser5Args("user2");
    ...
    @Test
    public void testOpenLodge2() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
            InvalidBirthdateException, PermissionException {
        User user = createUser5Args("user1");
        userService.signUp(user);
        User user2 = createUser5Args("user2");
    ...
    @Test
    public void testUnbanLodge() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
            InvalidBirthdateException, PermissionException {
        User user = createUser5Args("user1");
        userService.signUp(user);
        User user2 = createUser5Args("user2");
    ...
    @Test
    public void testUnbanLodge2() throws InstanceNotFoundException, DuplicateInstanceException, InvalidEmailException,
            InvalidBirthdateException, PermissionException {
        User user = createUser5Args("user1");
        userService.signUp(user);
        User user2 = createUser5Args("user2");
    ...
    public void testFindAllBannedLodges()
        ...
        List<Long> featureIds = new ArrayList<>(Arrays.asList(1L, 2L, 6L));
        List<String> imageUrls = new ArrayList<>(Arrays.asList("url1", "url2", "url3"));
        Lodge lodge1 = lodgeService.createLodge(user.getId(), "Lodge1@udc.es", "Lodge1", "Description", "Address",
                "981981981", "City", "Country", 5, 50, "12:00", "10:00", featureIds, imageUrls);
        Lodge lodge2 = lodgeService.createLodge(user.getId(), "Lodge2@udc.es", "Lodge1", "Description", "Address",
                "981981981", "City", "Country", 5, 50, "12:00", "10:00", featureIds, imageUrls);
        Lodge lodge3 = lodgeService.createLodge(user.getId(), "Lodge3@udc.es", "Lodge1", "Description", "Address",
