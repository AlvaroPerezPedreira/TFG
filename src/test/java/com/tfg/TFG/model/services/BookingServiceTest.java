...
public class BookingServiceTest {
    ...
    private Lodge createLodge(Long userId, String lodgeName)
        ...
        return lodgeService.createLodge(userId, lodgeName + "@" + "udc.es", lodgeName, "description",
                lodgeName + "address", "123321123", "city", "country", 4, 50, "12:00", "10:00", featureIds, imageUrls);
    }

    @Test
    public void testCreateBooking() throws DuplicateInstanceException, InvalidEmailException, InvalidBirthdateException,
    ...
    public void testCheckAvailability1()
        ...
        assertEquals(true, bookingService.checkAvailability(lodge.getLodge_email(), "01-03-2025", "03-03-2025"));
    }
    ...
    public void testCheckAvailability2()
        ...
        assertEquals(false, bookingService.checkAvailability(lodge.getLodge_email(), "01-03-2025", "03-03-2025"));
    }
    ...
    public void testReviewBooking()
        ...
        Booking booking = bookingService.createBooking(user.getId(), lodge.getLodge_email(), "12:00", "10:00",
                "01-03-2024", "07-03-2024", 100, false);
        Review review = bookingService.createReview(user.getId(), booking.getId(), lodge.getLodge_email(), "review",
                5);
    ...
    public void testGetReviewByEmail()
        ...
        Booking booking3 = bookingService.createBooking(user.getId(), lodge.getLodge_email(), "12:00", "10:00",
                "01-03-2024", "07-03-2024", 100, false);
        Review review1 = bookingService.createReview(user.getId(), booking1.getId(), lodge.getLodge_email(), "review",
                5);
        Review review2 = bookingService.createReview(user.getId(), booking2.getId(), lodge.getLodge_email(), "review",
                5);
        Review review3 = bookingService.createReview(user.getId(), booking3.getId(), lodge.getLodge_email(), "review",
                5);
    ...
    public void testBanReview1()
        ...
        Booking booking1 = bookingService.createBooking(user.getId(), lodge.getLodge_email(), "12:00", "10:00",
                "01-03-2024", "07-03-2024", 100, false);
        Review review = bookingService.createReview(user.getId(), booking1.getId(), lodge.getLodge_email(), "review",
                5);
