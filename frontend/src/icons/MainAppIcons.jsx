...
export function MailIcon({ color }) {
  return (
    ...
    >
      ...
      <rect x="1.5" y="4.36" width="21" height="15.27" stroke={color} />
      <polyline points="1.5 4.36 12 14.86 22.5 4.36" stroke={color} />
    </svg>
  );
}
...
export function MoneyIcon({ color }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
